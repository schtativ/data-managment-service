...
public class PostgreSqlConverter implements SqlConverter {
    ...
    private final String BOOLEAN_VALUE_YES = "YES";
    ...
    @Override
    public Boolean booleanValueFromSql(String value) {
        if (value == null) {
            return null;
        }

        return value.equalsIgnoreCase(BOOLEAN_VALUE_YES);
    }
    ...
    public String toSql(PrimaryKey primaryKey) {
        return String.format("id %s generated by default as identity constraint %s_%s_pkey primary key",
                dataTypeConverter.getDbmsTypeName(primaryKey.getType()),
    ...
    public <T extends DataTypeInfo> String toSql(DataTypeInfo dataTypeInfo, Class<T> clazz) {
        StringBuilder builder = new StringBuilder();
        builder.append(dataTypeConverter.getDbmsTypeName(dataTypeInfo.getType()));
